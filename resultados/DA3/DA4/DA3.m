...
function [notes_time, chords_with_bass, chord_pitch, chord_pitch_number] = DA3_window_44100(signal, fs)
    ...
    for time = 1:time_seconds_total
        ...
        set_of_windows_signals = build_window(signal, time, fs);
        ...
        % get energy of notes from new way
        set_of_notes_time = get_energy_notes_from_convolution(set_of_windows_signals, fs, time, set_of_notes_time);
    end
